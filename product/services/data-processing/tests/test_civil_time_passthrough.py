""" — civil-time context is carried C1 -> C2 verbatim, and DP adds nothing.
...
def test_absent_civil_time_stays_absent_not_null(client):
 ...
 or a fabricated 'UTC' would be the silent-wrong-timezone bug killed."""
...
def test_device_clock_reaches_c2_source_verbatim(client):
    """The trio's third member. prior C2 schema omitted device_clock (a
