...
- 2026-07-19 — **independent verification round** (recording/DP integrator session): the
  ...
  faster-whisper kwargs, AST ffmpeg decode path, real runs remain the node-7 smoke test, as
  this file already states). Two documented caveats, accepted not fixed: sidecar
