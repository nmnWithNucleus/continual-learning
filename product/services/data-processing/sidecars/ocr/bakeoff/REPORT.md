...
This is the strongest single piece of support for the design's `VIDEO_OCR_FRAME_WIDTH=1728` (no
resample) decision. *(Caveat: real CoreText output may ring more under x264 than Liberation-font
