...
This module is the **contract of record** for caption parse: guided
...
it, rather than a hollow record landing in ``/context`` (§5.3,).
...
def _clean(value: object) -> str:
 ...
 crucially for — newlines) to a single space, stripping the ends. A field
