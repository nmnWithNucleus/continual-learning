...
NO CONFIG anywhere in this package (L4): every output-affecting knob is a code pin in a
stage file, and identity is composed by the stage graph (``app/stagegraph``). There is
no ``config.py``/``mode.py``/``version.py`` env machinery here.
"""
