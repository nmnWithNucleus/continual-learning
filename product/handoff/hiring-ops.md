# Founders' thread — Hiring / Ops

> Running canvas for founders' hiring + operations sessions (launch:
> [../PROMPTS.md](../PROMPTS.md) §D). Staffing (agents now, humans later), vendors,
