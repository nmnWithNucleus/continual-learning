# Founders' thread — Research

> Running canvas for founders' research sessions (launch: [../PROMPTS.md](../PROMPTS.md) §D).
> The company research agenda and the POC ↔ product bridge. Service-level research
> questions live in the owning charter (mostly continuum + inference).
